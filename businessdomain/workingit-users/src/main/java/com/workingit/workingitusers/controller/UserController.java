...
//			result.put(message, userType);
	...
	public ResponseEntity<?> saveProfession (@PathVariable("userId") int userId, @RequestBody Profession profession ){
		 Profession professionNew = userService.saveProfession(profession, userId);
		 return new ResponseEntity<>(professionNew, HttpStatus.OK);
	}
}
